...
EXPLAIN SELECT o_custkey FROM orders LIMIT 10 OFFSET 15;

EXPLAIN SELECT o_custkey FROM orders GROUP BY o_custkey LIMIT 10 OFFSET 15;

EXPLAIN SELECT o_custkey FROM orders GROUP BY o_custkey ORDER BY o_custkey LIMIT 10 OFFSET 15;

EXPLAIN SELECT o_custkey, COUNT(*) AS ccnt FROM orders GROUP BY o_custkey ORDER BY ccnt LIMIT 10 OFFSET 15;
